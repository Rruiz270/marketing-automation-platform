...
export function getDefaultProjectsData(companyData) {
  if (!companyData) return [];
  
  const defaultProjects = [
    {
      id: `${companyData.user_id || 'default_user'}_default_1`,
      company_id: companyData.user_id || 'default_user',
      name: "Community Alumni",
      description: "Campanha para vender o curso Community Alumni focando no progresso rápido no idioma inglês para profissionais executivos.",
      targetAudience: "25 - 50 anos, executivos, empreendedores, pessoas que ganham mais de R$ 7k/mês",
      platforms: ["Google Ads", "Facebook Ads"],
      budget: "20000",
      objectives: "aumentar vendas e melhorar CAC",
      created_at: new Date().toISOString(),
      status: "active",
      isDefault: true
    },
    {
      id: `${companyData.user_id || 'default_user'}_default_2`, 
      company_id: companyData.user_id || 'default_user',
      name: "Expansão Corporate",
      description: "Campanha B2B para vender pacotes corporativos para empresas que querem treinar funcionários em inglês.",
      targetAudience: "Gerentes de RH, diretores, decisores empresariais",
      platforms: ["LinkedIn Ads", "Google Ads"],
      budget: "35000",
      objectives: "aumentar vendas B2B e expandir para mercado corporativo",
      created_at: new Date().toISOString(),
      status: "draft",
      isDefault: true
    },
    {
      id: `${companyData.user_id || 'default_user'}_default_3`,
      company_id: companyData.user_id || 'default_user', 
      name: "Retargeting Premium",
      description: "Campanha de retargeting para converter visitantes do site que não compraram, focando em urgência e desconto limitado.",
      targetAudience: "Visitantes do site, pessoas que abandonaram carrinho",
      platforms: ["Facebook Ads", "Google Ads"],
      budget: "15000",
      objectives: "melhorar taxa de conversão e reduzir CAC",
      created_at: new Date().toISOString(),
      status: "active",
      isDefault: true
    }
